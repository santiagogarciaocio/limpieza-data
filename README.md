...
Exportacion de la base de datos limpia.

Archivos:
Messy_Employee_dataset.csv -> base de datos inicial. Obtenida de kaggle https://www.kaggle.com/datasets/desolution01/messy-employee-dataset
Messy_Employee_dataset.py -> archivo python comentado y documentado con los pasos de limpiaza
clean_employee_dataser.csv -> base de datos limpia
